...
create_pdf("output_data/figures/figure_real-world-girg-1d_difference_cc.pdf", p, width = 0.45, height = 0.5)
...
create_pdf("output_data/figures/figure_real-world-girg-1d_difference_n.pdf", p, width = 0.45, height = 0.5)
...
create_pdf("output_data/figures/figure_real-world-girg-1d_difference_heterogeneity.pdf", p, width = 0.45, height = 0.5)
...
create_pdf("output_data/figures/figure_real-world-girg-1d_difference_d.pdf", p, width = 0.45, height = 0.5)
...
# Mean iterations
cat("Mean target n:", mean(tbl$n_true), "\n")

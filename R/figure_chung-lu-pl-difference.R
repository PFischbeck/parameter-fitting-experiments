...
tbl_true <- read.csv("output_data/target_params/chung-lu-pl.csv")
tbl_fitted <- read.csv("output_data/fitted_features/chung-lu-pl.csv")
# tbl_fitted <- tbl_fitted %>%
#     mutate(graph = sub("_seed=[0-9]*$", "", graph))
tbl_fitting_process <- read.csv("output_data/fitted_params/chung-lu-pl.csv")
...
tbl_generation_params <- read.csv("output_data/attributes/chung-lu-pl.csv")
...
create_pdf("output_data/figures/figure_chung-lu-pl_difference_n.pdf", p, width = 0.45, height = 0.5)
...
create_pdf("output_data/figures/figure_chung-lu-pl_difference_heterogeneity.pdf", p, width = 0.45, height = 0.5)
...
create_pdf("output_data/figures/figure_chung-lu-pl_difference_d.pdf", p, width = 0.45, height = 0.5)
